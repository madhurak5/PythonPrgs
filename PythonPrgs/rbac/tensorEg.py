...
# shape = (2,3,)
# oneTensor = torch.ones(shape)
# print(oneTensor)
# print(oneTensor.shape)
# print(oneTensor.dtype)
# print(oneTensor.device)
# if torch.cuda.is_available():
#     print("GPU available")
#     oneTensor = oneTensor.to('cuda')
# else:
...
# cleverhans.tf2.attacks.fast_gradient_method.fast_gradient_method()
# cleverhans.tf2.attacks.jsma()
print(cleverhans.tf2.attacks.fast_gradient_method())

# from cleverhans.future
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train MINST')
    print('hi')
