...
#                 # c = conn.cursor()
#
#                 c.execute("insert into  Patient (username, Fname, Lname, Pwd, CPwd, Gender, DoB, Place, Email, AARequest, DelUserStatus) values (?,?,?,?, ?,?,?,?, ?,?,?)",(values['username'], values['Fname'], values['Lname'], values['Pwd'], values['CPwd'],gen, values['DoB'], values['Place'],values['Email'],reqAA, delUser,))
